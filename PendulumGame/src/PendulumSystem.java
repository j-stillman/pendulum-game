...
public class PendulumSystem implements Entity {
	...
	public void add() {
		// method that adds a pendulum to our list and then creates a properties panel to control it
		...
		Pendulum pend = new Pendulum(anchor, Client.DEFAULT_RADIUS, Client.DEFAULT_SPEED, Client.DEFAULT_ANGLE);
	...
	public void add(double rad, double spd, double ang) {
		// This is a similar method to add(), but you can pass in the properties of the pendulum you create.
